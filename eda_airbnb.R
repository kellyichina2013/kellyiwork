...
fig_path = "/Users/kelly/Desktop/9530/midterm_project/eda_airbnb_fig"




df = read.csv('/Users/kelly/Desktop/9530/midterm_project/data/train_starting.csv')
...
utils$save_pdf(path = fig_path, name = "age_country")
...
utils$save_pdf(path = fig_path, name = "age_with_na")
...
utils$save_pdf(path = fig_path, name="age_gender")
...
utils$save_pdf(path = fig_path, name="time_booking")
...
utils$save_pdf(path = fig_path, name="time_to_book")
...
utils$save_pdf(path = fig_path, name="time_to_book)1")
...
utils$save_pdf(path = fig_path, name="wait_book")
...
utils$save_pdf(path = fig_path, name="time_country")
